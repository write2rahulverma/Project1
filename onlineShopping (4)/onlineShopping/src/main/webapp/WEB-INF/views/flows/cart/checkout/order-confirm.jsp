		    		...
		    		<div class="row">
		    			<div class="col-xs-6">
		    				...
		    				<strong>Billed To:</strong><br>
		    					${Name}<br/>
		    					${orderDetail.billing.apartmentNumber}<br>
		    					${orderDetail.billing.streetName}<br>
		    					${orderDetail.billing.city} - ${orderDetail.billing.zipCode}<br>
		    			...
		    			<div class="col-xs-6 text-right">
		        			...
		        			<strong>Shipped To:</strong><br>
		    					${Name}<br>
		    					${orderDetail.shipping.apartmentNumber}<br>
		    					${orderDetail.shipping.streetName}<br>
		    					${orderDetail.shipping.city} - ${orderDetail.shipping.zipCode}<br>
